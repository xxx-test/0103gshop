...
// [2、获取食品分类列表]
export const reqFoodType = () => ajax('/index_catefory')
// [3、根据经纬度获取商铺列表]
export const reqShops = (latitude, longitude) => ajax('/shops',{latitude, longitude})
// [4、根据经纬度和关键字搜索商铺列表]
export const reqShopList = (geohash, keyword) => ajax('/search_shop',{geohash, keyword})
// [5、获取一次性验证码]
...
// [8、手机号验证码登陆]
export const reqSmsLogin = (phone, code) => ajax('/login+sms',{phone,code})
// [9、根据会话获取用户信息]
